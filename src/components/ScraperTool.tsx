...
export default function ScraperTool() {
  ...
  const [method, setMethod] = useState<"cheerio" | "puppeteer">("puppeteer");
  ...
  return (
    <div className="w-full max-w-4xl mx-auto p-6">
      <h2 className="text-2xl font-bold mb-6 text-gray-800">Advanced Web Scraper</h2>
        ...
        <div className="flex flex-col md:flex-row gap-4 mb-4">
          ...
          <div className="md:w-48">
            ...
            <select
              id="method"
              value={method}
              onChange={(e) => setMethod(e.target.value as "cheerio" | "puppeteer")}
              className="w-full px-4 py-2 border border-gray-200 rounded-md focus:outline-none focus:ring-2 focus:ring-teal-500 focus:border-transparent"
            >
            ...
            <div className="mt-4 pt-4 border-t border-red-100">
              ...
              <div className="mt-4">
                ...
                <ul className="list-disc pl-5 text-sm space-y-1">
                  ...
                  <li>Try using the Cheerio method for simpler websites</li>
